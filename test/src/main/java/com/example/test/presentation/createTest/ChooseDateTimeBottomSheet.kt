package com.example.test.presentation.createTest
...
import com.example.test.databinding.FragmentChooseDateBinding
...
class ChooseDateTimeBottomSheet(private val listener: (NewTestDetail, BottomSheetDialogFragment) -> Unit) :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.uploadTestBtn.setOnClickListener {
            ...
            //Code to upload test to firestore db

            listener.invoke(
                TestCreationHandler.getNewTestDetails(
